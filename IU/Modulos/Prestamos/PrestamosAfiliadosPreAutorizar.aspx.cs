...
{
    public partial class PrestamosAfiliadosPreAutorizar : PaginaAfiliados
    {
        protected override void PageLoadEventAfiliados(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.ModificarDatos.IniciarControl(prestamoAfiliado, Gestion.Modificar, IU.Modulos.Prestamos.Controles.PrestamoAfiliadoModificarDatos.TipoAutorizar.PreAutorizar);
            }
        }
