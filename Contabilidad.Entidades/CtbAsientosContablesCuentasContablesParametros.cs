...
namespace Contabilidad.Entidades
{
    ...
    public partial class CtbAsientosContablesCuentasContablesParametros : Objeto
    {
        ...
        string _bancoCuentaDescripcion;
        #endregion
        ...
        public string BancoCuentaBancoDescripcion
        {
         ...
         public string BancoCuentaDescripcion
        {
            get { return _bancoCuentaDescripcion == null ? string.Empty : _bancoCuentaDescripcion; }
            set { _bancoCuentaDescripcion = value; }
        }
