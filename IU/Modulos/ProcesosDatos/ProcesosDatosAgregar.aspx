<%@ Page Language="C#" MasterPageFile="~/Maestra.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ProcesosDatosAgregar.aspx.cs" Inherits="IU.Modulos.ProcesosDatos.ProcesosDatosAgregar" Title="" %>
<%@ Register Src="~/Modulos/ProcesosDatos/Controles/ProcesosDatosModificarDatos.ascx" TagPrefix="AUGE" TagName="ModificarDatos" %>
