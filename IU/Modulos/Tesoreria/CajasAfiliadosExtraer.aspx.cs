...
{
    public partial class CajasAfiliadosExtraer : PaginaCajasAfiliados
    {
        ...
        {
            TGETiposOperaciones tipoOpe = TGEGeneralesF.TiposOperacionesObtenerDatosCompletos(EnumTGETiposOperaciones.CuentaCorrienteExtraccion);
