...
{
    public partial class CajasMovimientosAnular : PaginaSegura
    {
        protected override void PageLoadEvent(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.ModificarDatos.IniciarControl(movimiento, new TESCajas(), Gestion.Anular);
            }
        }

        void ModificarDatos_ModificarDatosCancelar()
        {
            string url = "~/Modulos/Tesoreria/CajasMovimientosAnular.aspx";
