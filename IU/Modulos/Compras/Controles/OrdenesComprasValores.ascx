<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrdenesComprasValores.ascx.cs" Inherits="IU.Modulos.Compras.Controles.OrdenesComprasValores" %>
                    ...
                    <asp:UpdatePanel ID="upValores" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="form-control select2" ID="ddlTiposValores" runat="server" OnSelectedIndexChanged="ddlTiposValores_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
