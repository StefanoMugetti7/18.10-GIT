<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="DepartamentosListar.aspx.cs" Inherits="IU.Modulos.Contabilidad.DepartamentosListar" %>

<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="DepartamentosListar">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvDatos" OnRowCommand="gvDatos_RowCommand" AllowPaging="true" AllowSorting="true"
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Código Departamento" DataField="CodigoDepartamento" SortExpression="CodigoDepartamento" />
