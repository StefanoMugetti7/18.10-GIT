...
{
    public partial class FacturasSimplesAgregar : PaginaSegura
    {
        protected override void PageLoadEvent(object sender, EventArgs e)
        {
            ...
            this.ModificarDatos.FacturaModificarDatosCancelar +=new Controles.FacturasSimplesDatos.FacturasDatosCancelarEventHandler(ModificarDatos_FacturaModificarDatosCancelar);
            if (!this.IsPostBack)
            {
