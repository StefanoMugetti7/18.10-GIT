...
{
    public partial class PlazosConsultar : PaginaSegura
    {
        protected override void PageLoadEvent(object sender, EventArgs e)
        {
            base.PageLoadEvent(sender, e);
            this.ConsultarDatos.PlazosDatosAceptar += new IU.Modulos.Ahorros.Controles.PlazosDatos.PlazosDatosAceptarEventHandler(AgregarDatos_PlazosDatosAceptar);
            this.ConsultarDatos.PlazosDatosCancelar += new IU.Modulos.Ahorros.Controles.PlazosDatos.PlazosDatosCancelarEventHandler(AgregarDatos_PlazosDatosCancelar);
            if (!this.IsPostBack)
            {
                ...
                this.ConsultarDatos.IniciarControl(plazos, Gestion.Consultar);
            }
        }
