...
{
    public partial class FamiliaresModificar : PaginaAfiliados
    {
        protected override void PageLoadEvent(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                if (!this.MisParametrosUrl.Contains("IdFamiliar"))
                ...
                familiar.IdAfiliado = Convert.ToInt32(this.MisParametrosUrl["IdFamiliar"]);
                familiar.AfiliadoTipo.IdAfiliadoTipo = (int)EnumAfiliadosTipos.Familiares;
                this.ModifDatos.IniciarControl(familiar, Gestion.Modificar);
            }
        }
