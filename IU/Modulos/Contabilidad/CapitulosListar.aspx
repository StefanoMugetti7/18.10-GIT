<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="CapitulosListar.aspx.cs" Inherits="IU.Modulos.Contabilidad.CapitulosListar" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <asp:TextBox CssClass="form-control" ID="txtCodigoCapitulo" runat="server" />
                    </div>
                ...
                <asp:GridView ID="gvDatos" OnRowCommand="gvDatos_RowCommand" AllowPaging="true" AllowSorting="true"
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Código Capítulo" DataField="CodigoCapitulo" SortExpression="CodigoCapitulo" />
                        <asp:BoundField HeaderText="Capítulo" DataField="Capitulo" SortExpression="Capitulo" />
