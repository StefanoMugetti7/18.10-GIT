<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="AcopiosModificar.aspx.cs" Inherits="IU.Modulos.Acopios.AcopiosModificar" %>
<%@ Register Src="~/Modulos/Acopios/Controles/AcopiosModificarDatos.ascx" TagPrefix="EVOL" TagName="ModificarDatos" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <EVOL:ModificarDatos ID="ModificarDatos" runat="server" />
</asp:Content>
