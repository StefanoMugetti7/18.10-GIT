...
{
    public partial class ClientesBuscarPopUp : ControlesSeguros
    {
        ...
        protected override void PageLoadEvent(object sender, EventArgs e)
        {
            ...
            this.ctrAfiliados.AfiliadosBuscarSeleccionar += new ClientesBuscar.AfiliadosBuscarEventHandler(ctrAfiliados_AfiliadosBuscarSeleccionar);
            this.ctrAfiliados.AfiliadosEventos += new ClientesBuscar.AfiliadosEventosEventHandler(ctrAfiliados_AfiliadosEventos);
            //this.ctrAfiliados.AfiliadosVolver += new ClientesBuscar.AfiliadosVolverEventHandler(ctrAfiliados_AfiliadosVolver);
        }

        //void ctrAfiliados_AfiliadosVolver()
        //{
        //    this.mpePopUp.Hide();
        //}
        ...
        {
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "popUpModal", "ShowModalBuscarCliente();", true);
        }

        void ctrAfiliados_AfiliadosBuscarSeleccionar(AfiAfiliados e)
        {
            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "popUpModal", "HideModalBuscarCliente();", true);
        ...
        {
            this.ctrAfiliados.IniciarControl(pAfiliado, pPanelBuscar, pAfiliadoTipo, pLimpiarDatos, pFiltrarAfiliados);
        }
    }
}
