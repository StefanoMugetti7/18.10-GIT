...
{
    public partial class OrdenesComprasValores : ControlesSeguros
    {
        private CmpOrdenesCompras MiOrdenCompra
        {
            get { return (CmpOrdenesCompras)Session[this.MiSessionPagina + "OrdenesComprasValoresMiOrdenCompra"]; }
            set { Session[this.MiSessionPagina + "OrdenesComprasValoresMiOrdenCompra"] = value; }
        }
        private List<TESBancosCuentas> MisBancosCuentas
        {
            get { return (List<TESBancosCuentas>)Session[this.MiSessionPagina + "OrdenesComprasValoresMisBancosCuentas"]; }
            set { Session[this.MiSessionPagina + "OrdenesComprasValoresMisBancosCuentas"] = value; }
        }
        private List<TESBancosCuentas> MisBancosCuentasTarjetas
        {
            get { return (List<TESBancosCuentas>)Session[this.MiSessionPagina + "OrdenesComprasValoresMisBancosCuentasTarjetas"]; }
            set { Session[this.MiSessionPagina + "OrdenesComprasValoresMisBancosCuentasTarjetas"] = value; }
        }
        ...
        public void IniciarControl(CmpOrdenesCompras pOrdenCompra, Gestion pGestion)
        {
            this.GestionControl = pGestion;
            this.MiOrdenCompra = pOrdenCompra;
            switch (pGestion)
            {
                ...
                case Gestion.Consultar:
                    ...
                    AyudaProgramacion.CargarGrillaListas<CapOrdenesComprasValores>(this.MiOrdenCompra.OrdenesComprasValores, false, this.gvFormasCobros, true);
                    break;
                default:
                    break;
            }
        ...
        private void HabilitarTransferencias()
        {
            ...
            if (Convert.ToInt32(ddlTiposValores.SelectedValue) == (int)EnumTiposValores.Transferencia)
            {
                ...
                if (this.MiOrdenCompra.Entidad.IdRefEntidad > 0)
                {
                    CapOrdenesPagos op = new CapOrdenesPagos(); // NO HACE FALTA CREAR NUEVOS METODOS YA QUE SOLO BUSCO EL CBU
                    op.Entidad.IdEntidad = MiOrdenCompra.Entidad.IdEntidad;
                    op.Entidad.IdRefEntidad = MiOrdenCompra.Entidad.IdRefEntidad;
                    CapOrdenesPagosValores aux = CuentasPagarF.OrdenesPagosObtenerCbu(op);
        ...
        public List<CapOrdenesComprasValores> ObtenerOrdenesComprasValores()
        {
            this.PersistirDatosGrilla();
            return this.MiOrdenCompra.OrdenesComprasValores;
        }
        ...
        protected void btnIngresarCobro_Click(object sender, EventArgs e)
        {
            ...
            CapOrdenesComprasValores valor;
            //EFECTIVO
            if (tipoValor.IdTipoValor == (int)EnumTiposValores.Efectivo)
            {
                if (this.MiOrdenCompra.OrdenesComprasValores.Exists(x => x.TipoValor.IdTipoValor == (int)EnumTiposValores.Efectivo))
                    this.MiOrdenCompra.OrdenesComprasValores.Find(x => x.TipoValor.IdTipoValor == (int)EnumTiposValores.Efectivo).Importe = this.txtImporte.Decimal;
                else
                {
                    valor = new CapOrdenesComprasValores();
                    valor.EstadoColeccion = EstadoColecciones.Agregado;
                    valor.TipoValor = tipoValor;
                    valor.Importe = this.txtImporte.Decimal;
                    this.MiOrdenCompra.OrdenesComprasValores.Add(valor);
                    valor.IndiceColeccion = this.MiOrdenCompra.OrdenesComprasValores.IndexOf(valor);
                }
            }//CHEQUE
            ...
            else if (tipoValor.IdTipoValor == (int)EnumTiposValores.Transferencia || tipoValor.IdTipoValor == (int)EnumTiposValores.EfectivoFondoFijo)
            {
                ...
                this.MiOrdenCompra.OrdenesComprasValores.Add(valor);
                valor.IndiceColeccion = this.MiOrdenCompra.OrdenesComprasValores.IndexOf(valor);
                valor.Fecha = this.txtFechaTransferencia.Text == string.Empty ? this.MiOrdenCompra.FechaPago : Convert.ToDateTime(this.txtFechaTransferencia.Text);
            ...
            {
                if (Convert.ToInt32(this.txtCantidadCuotas.Text) < 1)
                {
                    this.MostrarMensaje("La cantidad de cuotas debe ser mayor a 0.", true);
                    return;
                }
        ...
        protected void btnBuscarCheque_Click(object sender, EventArgs e)
        {
            ...
            foreach (CapOrdenesComprasValores valores in this.MiOrdenCompra.OrdenesComprasValores)
            {
        ...
        void ctrBuscarChequesPopUp_ChequesTercerosSeleccionar(global::Bancos.Entidades.TESCheques e)
        {
            ...
            CapOrdenesComprasValores valor = new CapOrdenesComprasValores();
            valor.Cheque = e;
        ...
        protected void gvFormasCobros_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            CapOrdenesComprasValores detalle = MiOrdenCompra.OrdenesComprasValores[indiceColeccion];
            this.MiOrdenCompra.OrdenesComprasValores.Remove(detalle);
            MiOrdenCompra.OrdenesComprasValores = AyudaProgramacion.AcomodarIndices<CapOrdenesComprasValores>(this.MiOrdenCompra.OrdenesComprasValores);
            AyudaProgramacion.CargarGrillaListas<CapOrdenesComprasValores>(MiOrdenCompra.OrdenesComprasValores, false, this.gvFormasCobros, true); ;
            this.UpdatePanel2.Update();
        }
        ...
        protected void gvFormasCobros_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                CapOrdenesComprasValores detalle = (CapOrdenesComprasValores)e.Row.DataItem;
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                lblTotal.Text = this.MiOrdenCompra.OrdenesComprasValores.Sum(x => x.Importe).ToString("C2");
        ...
        protected void gvFormasCobros_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            this.gvFormasCobros.DataSource = this.MiOrdenCompra;
        ...
        private void PersistirDatosGrilla()
        {
            foreach (GridViewRow fila in this.gvFormasCobros.Rows)
            {
                ...
                {
                    this.MiOrdenCompra.OrdenesComprasValores[fila.DataItemIndex].FechaDiferido = Convert.ToDateTime(fechaDiferido.Text);
                    this.MiOrdenCompra.OrdenesComprasValores[fila.DataItemIndex].EstadoColeccion = AyudaProgramacion.ObtenerEstadoColeccion(this.MiOrdenCompra.OrdenesComprasValores[fila.DataItemIndex], this.GestionControl);
                }
            }
        }
    }
