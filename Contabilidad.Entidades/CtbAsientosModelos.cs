...
namespace Contabilidad.Entidades
{
  [Serializable]
    ...
    XmlDocumentSerializationWrapper _loteCuentasContables;
	#endregion
	...
	public string Detalle
	{
      ...
      public bool ModificarAsientos
      {
          get { return _modificarAsientos; }
          set { _modificarAsientos = value; }
      }
    ...
    public XmlDocument LoteCuentasContables
    {
        get { return _loteCuentasContables; }//==null ? (_lotePrestamos=new XmlDocument()) : _lotePrestamos; }
        set { _loteCuentasContables = value; }
    }
