<%@ Page Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="ParametrosModificar.aspx.cs" Inherits="IU.Modulos.TGE.ParametrosModificar" Title="" %>
<%@ Register Src="~/Modulos/TGE/Control/ParametrosDatos.ascx" TagPrefix="AUGE" TagName="ConsultarDatos" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <AUGE:ConsultarDatos ID="ctrParametros" runat="server" />
</asp:Content>
