<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MailingProcesamientosPlantillasDatos.ascx.cs" Inherits="IU.Modulos.Mailing.Controles.MailingProcesamientosPlantillasDatos" %>
...
<div class="form-group row">
    ...
    <div class="col-sm-3"> <asp:TextBox CssClass="form-control" ID="txtCodigo" Enabled="false" runat="server" />
...
<asp:TextBox CssClass="form-control" ID="txtPlantilla" Enabled="false" runat="server" />
     ...
     <asp:RequiredFieldValidator ID="rfvPlantilla" ControlToValidate="txtPlantilla" ValidationGroup="Aceptar" CssClass="Validador" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator></div>
...
<asp:TextBox CssClass="form-control" ID="txtStore" Enabled="false" runat="server" />
    ...
    <div class="col-sm-3">  <Evol:CurrencyTextBox CssClass="form-control" ID="txtHojaAlto" prefix="" Enabled="false" runat="server" /></div>
                <asp:Label CssClass="col-sm-1 col-form-label" ID="lblHojaAncho" runat="server" Text="Hoja Ancho"/>
  
    <div class="col-sm-3"> <Evol:CurrencyTextBox CssClass="form-control" ID="txtHojaAncho" prefix="" Enabled="false" runat="server" /></div>
    ...
    <div class="col-sm-3"> <Evol:CurrencyTextBox CssClass="form-control" ID="txtMargenIzquierdo" prefix="" Enabled="false" runat="server" /></div>
 
                
                <asp:Label CssClass="col-sm-1 col-form-label" ID="lblMargenDerecho" runat="server" Text="Margen Derecho"/>
  
    <div class="col-sm-3"> <Evol:CurrencyTextBox CssClass="form-control" ID="txtMargenDerecho" prefix="" Enabled="false" runat="server" /></div>
          
             <asp:Label CssClass="col-sm-1 col-form-label" ID="lblMargenSuperior" runat="server" Text="Margen Superior"/>
  
    <div class="col-sm-3"> <Evol:CurrencyTextBox CssClass="form-control" ID="txtMargenSuperior" prefix="" Enabled="false" runat="server" /></div>
    ...
    <div class="col-sm-3"> <Evol:CurrencyTextBox CssClass="form-control" ID="txtMargenInferior" prefix="" Enabled="false" runat="server" /></div>
  

                <asp:Label CssClass="col-sm-1 col-form-label" ID="lblNumerarPaginas" runat="server" Text="Numerar Páginas"/>
  
    <div class="col-sm-3"> <asp:DropDownList CssClass="form-control select2" ID="ddlNumerarPaginas"  runat="server" >
        ...
        <asp:ImageButton ID="imgUploadFile" Visible="false" ImageUrl="~/Imagenes/updateprogress.gif" runat="server" />
         ...
         <asp:Image ID="imgLogo" runat="server" Width="200px" Visible = "false"/>
             ...
             <asp:Button CssClass="botonesEvol" ID="btnBorrarImagen" Text="Borrar Imagen" runat="server" Visible="false" OnClick="btnBorrarImagen_Click"/>
                ...
                <div class="form-group row">
                    <div class="col-sm-2">
                  <asp:Button CssClass="botonesEvol" ID="btnPlantilla" runat="server" Text="Agregar Subplantilla" onclick="btnAgregarPlantilla_Click"/></div></div>
...
<div class="columns"> 
    ...
    <div class="campos">
         ...
         <br />
        <asp:ListBox CssClass="listbox" Width="100%" ID="lstCampos" Rows="15" runat="server" >
        </asp:ListBox>
        <br />
