...
namespace Bancos.Entidades
{
  [Serializable]
    ...
    int _idBancoCuenta;
    bool _chequePropio;
    int? _idCajaMovimientoValorEntregado;
    //AGREGO IdRefTipoOperacion para obtener el comprobante de la operacion
    ...
    public string CUIT
    {
      ...
      public string BancoTitularCuit
      {
          get { return string.Concat(this.Banco.Descripcion.Length > 0 ? " - " : string.Empty, Banco.Descripcion, this.TitularCheque.Length > 0 ? " - " : string.Empty, this.TitularCheque, this.CUIT.Length > 0 ? " - " : string.Empty, this.CUIT); }
    ...
    public int? IdCajaMovimientoValorEntregado
    {
        get { return _idCajaMovimientoValorEntregado; }
        set { _idCajaMovimientoValorEntregado = value; }
