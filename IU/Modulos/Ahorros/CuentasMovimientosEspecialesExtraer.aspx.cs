...
{
    public partial class CuentasMovimientosEspecialesExtraer : PaginaAfiliados
    {
        protected override void PageLoadEventAfiliados(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.DepositarDatos.IniciarControl(cuentasMovimientos, EnumTGETiposMovimientos.Debito);
            }
        }
