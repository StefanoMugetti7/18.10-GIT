...
{
    public partial class AfiliadosDatosUIFModificar : PaginaAfiliados
    {
        protected override void PageLoadEventAfiliados(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                if (afi.IdAfiliadoDatosUIF > 0)
                    this.ModificarDatos.IniciarControl(afi, afiliado,Gestion.Modificar);
                else
                    this.ModificarDatos.IniciarControl(afi, afiliado,Gestion.Agregar);
