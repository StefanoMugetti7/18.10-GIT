<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BancosCuentasMovimientosDatos.ascx.cs" Inherits="IU.Modulos.Bancos.Controles.BancosCuentasMovimientosDatos" %>
...
<div class="BancosCuentasMovimientosDatos">
    ...
    <div class="col-sm-3"><asp:TextBox CssClass="form-control" ID="txtBanco" Enabled="false" runat="server"></asp:TextBox>
  </div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblNumeroCuenta" runat="server" Text="Numero Cuenta" />
   <div class="col-sm-3"> <asp:TextBox CssClass="form-control" ID="txtNumeroCuenta" Enabled="false" runat="server" />
  </div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblEstado" runat="server" Text="Estado" />
   <div class="col-sm-3"> <asp:TextBox CssClass="form-control" ID="txtEstado" Enabled="false" runat="server" />
   </div>
              </div>
          <div class="form-group row">
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblDenominacion" runat="server" Text="Denominacion" />
  <div class="col-sm-3">  <asp:TextBox CssClass="form-control" ID="txtDenominacion" Enabled="false" runat="server" />
  </div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblNumeroBancoSucursal" runat="server" Text="Numero Banco Sucursal" />
   <div class="col-sm-3"> <AUGE:NumericTextBox CssClass="form-control" ID="txtNumeroBancoSucursal" Enabled="false" runat="server" />
 </div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblBancoCuentaTipo" runat="server" Text="Tipo Cuenta" />
   <div class="col-sm-3"> <asp:TextBox CssClass="form-control" ID="txtTipoCuenta" Enabled="false" runat="server" />
   </div></div>
          <div class="form-group row">
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblFecha" runat="server" Text="Fecha" />
  <div class="col-sm-3">  <asp:TextBox CssClass="form-control" ID="txtFechaMovimiento" Enabled="false" runat="server" />
  </div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblFechaConciliacionBanco" runat="server" Text="Fecha Banco" />
  <div class="col-sm-3">  <asp:TextBox CssClass="form-control datepicker" ID="txtFechaConciliacionBanco" Enabled="false" runat="server"></asp:TextBox>
  ...
  <div class="col-sm-3">  <asp:DropDownList CssClass="form-control select2" ID="ddlTipoOperacion" runat="server" OnSelectedIndexChanged="ddlTipoOperacion_OnSelectedIndexChanged"
        AutoPostBack="true"/>
    <asp:RequiredFieldValidator CssClass="Validador" ID="rfvTipoOperacion" runat="server" ControlToValidate="ddlTipoOperacion" 
        ErrorMessage="*" ValidationGroup="BancosCuentasMovimientosDatos"/>
</div>
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblConceptos" runat="server" Text="Concepto"></asp:Label>
  <div class="col-sm-3">  <asp:DropDownList CssClass="form-control select2" ID="ddlConceptosContables" runat="server" OnSelectedIndexChanged="ddlConceptosContables_OnSelectedIndexChanged"
                    AutoPostBack="true">
    </asp:DropDownList>
  ...
  </div>          <asp:Panel runat="server" ID="pnlFilialDestino" Visible="false">      <div class="form-group row">
                <asp:Label CssClass="col-sm-1 col-form-label" ID="lblFilialDestino" runat="server" Text="Filial destino"></asp:Label>
        <div class="col-sm-3">        <asp:DropDownList CssClass="form-control select2" ID="ddlFiliales" runat="server" OnSelectedIndexChanged="ddlFiliales_OnSelectedIndexChanged"
                    AutoPostBack="true">
                </asp:DropDownList>
                <asp:RequiredFieldValidator CssClass="Validador" ID="rfvFiliales" Enabled="false" runat="server" ControlToValidate="ddlFiliales" 
                    ErrorMessage="*" ValidationGroup="BancosCuentasMovimientosDatos"/></div>
       </div>     </asp:Panel>
            <asp:Panel runat="server" ID="pnlCuentaInternaDestino" Visible="false" >      <div class="form-group row">
                <asp:Label CssClass="col-sm-1 col-form-label" ID="lblBancoDestino" runat="server" Text="Banco destino"></asp:Label>
          <div class="col-sm-3">      <asp:DropDownList CssClass="form-control select2" ID="ddlBancos" runat="server" OnSelectedIndexChanged="ddlBancos_OnSelectedIndexChanged"
                    AutoPostBack="true">
                </asp:DropDownList>
             ...
             <div class="col-sm-3">   <asp:DropDownList CssClass="form-control select2" ID="ddlBancosCuentas" runat="server">
                </asp:DropDownList>
    ...
    </asp:UpdatePanel>          <div class="form-group row">
    <asp:Label CssClass="col-sm-1 col-form-label" ID="lblNumeroTipoOperacion" runat="server" Text="Numero Operacion" />
   <div class="col-sm-3"> <asp:TextBox CssClass="form-control" ID="txtNumeroTipoOperacion" MaxLength="50" runat="server"></asp:TextBox>
   </div>
    ...
    <%--<asp:RequiredFieldValidator CssClass="Validador" ID="rfvDetalle" runat="server" ControlToValidate="txtDetalle" 
            ErrorMessage="*" ValidationGroup="BancosCuentasMovimientosDatos"/>--%>
  </div></div>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server" >
        <ContentTemplate>
            ...
            <asp:ImageButton ImageUrl="~/Imagenes/print_f2.png" runat="server" ID="btnImprimir" Visible="false"
                ...
                <asp:Button CssClass="botonesEvol" ID="btnAceptar" runat="server" Text="Aceptar" onclick="btnAceptar_Click" ValidationGroup="BancosCuentasMovimientosDatos" />
