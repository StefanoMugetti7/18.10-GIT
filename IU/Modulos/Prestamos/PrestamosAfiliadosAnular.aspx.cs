...
{
    public partial class PrestamosAfiliadosAnular : PaginaAfiliados
    {
        protected override void PageLoadEventAfiliados(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.ModificarDatos.IniciarControl(prestamoAfiliado, Gestion.Anular, IU.Modulos.Prestamos.Controles.PrestamoAfiliadoModificarDatos.TipoAutorizar.SinPrivilegio);
            }
        }
