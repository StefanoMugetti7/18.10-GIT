<%@ Page Language="C#" MasterPageFile="~/Maestra.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SegMenuesModificar.aspx.cs" Inherits="IU.Modulos.Seguridad.SegMenuesModificar"  %>
<%@ Register Src="~/Modulos/Seguridad/Controles/SegMenuesModificarDatos.ascx" TagPrefix="AUGE" TagName="ModificarDatos" %>
